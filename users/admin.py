...
class PersonAdmin(admin.ModelAdmin):
    list_display = ['phone_number', 'national_id', 'full_name', 'user_mode', 'user_status', 'is_verified']
    ...
    fieldsets = (
        ('Personal Info', {
            'fields': ('phone_number', 'national_id', 'full_name','mentioned_name', 'oldest_creditor','old_phone_number','mentioned_phone_number','address')
        }),
        ('Status', {
